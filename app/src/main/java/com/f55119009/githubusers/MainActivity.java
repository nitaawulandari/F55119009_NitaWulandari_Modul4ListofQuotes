package com.f55119009.githubusers;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("List of Quotes / F55119009");
        }
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "token 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");
